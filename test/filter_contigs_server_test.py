...
class filter_contigsTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('filter_contigs'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = filter_contigs(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_filter_contigs_" + str(suffix)
